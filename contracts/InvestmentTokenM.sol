...
// TokenX Contracts v1.0.0 (contracts/InvestmentTokenM.sol)
 ...
 */
contract InvestmentTokenM is Ownable, Pausable, ERC20Burnable, ERC20Mintable, ERC20AllowListableProxy, EmergencyWithdrawable {
    ...
    /**
     * @dev Leaves the contract without mint capabilities. It will not be possible to call
